...
<form class="card p-4" method="post" action="{{$item->exists?route('inventory.update',$item):route('inventory.store')}}">@csrf @if($item->exists)@method('put')@endif<div class="row g-3">
        ...
        <div class="col-md-6"><label class="form-label">Brand *</label><select class="form-select" name="brand_id" required>
        ...
        <div class="col-md-6"><label class="form-label">Category *</label><select class="form-select" name="category_id" required>
        ...
        <div class="col-md-4"><label class="form-label">Quantity *</label><input class="form-control" type="number" step="0.01" min="0" name="quantity" value="{{old('quantity',$item->quantity??0)}}" required></div>
        ...
        <div class="col-md-4"><label class="form-label">Purchase Price *</label><input class="form-control" type="number" step="0.01" min="0" name="purchase_price" value="{{old('purchase_price',$item->purchase_price)}}" required></div>
